...
function AnimatedCounter({ target, suffix = "", prefix = "" }: { target: string; suffix?: string; prefix?: string }) {
  ...
  useEffect(() => {
    ...
    if (isNaN(numeric)) { setDisplay(prefix + target + suffix); return; }
    ...
    const timer = setInterval(() => {
      ...
      if (step >= steps) { clearInterval(timer); setDisplay(prefix + target + suffix); }
    }, interval);
...
const features = [
  {
    ...
    description: "Linked P&L, Balance Sheet, and Cash Flow projections with cascading recalculation across multiple years.",
  ...
  },
  {
    icon: TrendingUp,
    title: "DCF & Valuation",
    description: "WACC-driven DCF, 5x5 sensitivity tables, and multi-method comparisons with bull/base/bear scenarios.",
  ...
  },
  {
    ...
    description: "10-year mixed-period forecasting with growth decay, margin convergence, and scenario multipliers.",
  ...
  },
  {
    ...
    description: "Live market data, MA50/MA200 indicators, golden cross detection, stop-loss alerts, and risk analysis.",
  ...
  },
  {
    ...
    description: "Tokenomics modeling, DeFi protocol revenue from DefiLlama, and honest valuation for digital assets.",
  ...
  },
  {
    icon: Brain,
    title: "AI Copilot",
    description: "GPT-powered assistant that reads your models and delivers real-time analysis, insights, and recommendations.",
...
const whyKozo = [
  {
    ...
    description: "Change one number and watch it ripple through every financial statement, DCF, and valuation model instantly. No manual re-linking.",
  },
  {
    icon: Shield,
    title: "Institutional-Grade Analysis",
    description: "The same methodologies used by Wall Street analysts: WACC, sensitivity tables, comparable analysis, and scenario modeling.",
  },
  {
    icon: RefreshCw,
    title: "Live Market Data",
    description: "Real-time feeds from Yahoo Finance, FRED, DefiLlama, and CoinGecko. Your models always reflect the latest market conditions.",
  },
  {
    icon: FileText,
    title: "SEC EDGAR Integration",
    description: "Import 10-K filings directly. Ticker search, iXBRL parsing, and automatic population of all three financial statements.",
  },
];
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 bg-background/60 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4 px-6 py-3">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-semibold tracking-tight" data-testid="text-brand-name">Kozo</span>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((s, i) => (
              ...
              >
                ...
                <div className="text-4xl font-bold bg-gradient-to-r from-blue-500 to-violet-500 bg-clip-text text-transparent mb-1" data-testid={`text-stat-value-${i}`}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 mb-4 px-3 py-1.5 rounded-md bg-violet-500/10 border border-violet-500/20">
              ...
              <span className="text-xs font-medium text-violet-500 tracking-wide uppercase">Why Kozo</span>
            </div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight" data-testid="text-why-heading">
              Built for{" "}
              <span className="bg-gradient-to-r from-violet-500 to-blue-500 bg-clip-text text-transparent">
                serious analysis
              </span>
            </h2>
            <p className="text-muted-foreground max-w-2xl mx-auto" data-testid="text-why-description">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {whyKozo.map((item, i) => (
              ...
              >
                <Card className="relative p-6 h-full overflow-visible" data-testid={`card-why-${i}`}>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1.5" data-testid={`text-why-title-${i}`}>{item.title}</h3>
          ...
          <div className="relative overflow-hidden rounded-md border border-border/50 bg-gradient-to-br from-blue-600/5 via-violet-600/5 to-cyan-600/5">
            ...
            <div className="relative px-8 py-16 md:px-14 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-lg mx-auto" data-testid="text-cta-description">
                Join analysts and investors using Kozo to build better
      ...
      <footer className="border-t border-border/50 py-8">
        <div className="max-w-7xl mx-auto px-6 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-sm text-muted-foreground font-medium" data-testid="text-footer-brand">Kozo</span>
          </div>
