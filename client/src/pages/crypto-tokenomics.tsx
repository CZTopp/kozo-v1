      ...
      <Tabs defaultValue="allocations" data-testid="tabs-tokenomics">
        ...
        <TabsContent value="allocations" className="mt-4 space-y-4">
          ...
          {allocations && allocations.length > 0 && allocations.some((a: any) => a.dataSource?.includes("AI-Researched") || a.assumption?.includes("AI-Researched")) && (
            <div className="flex items-start gap-2 p-3 rounded-md border border-yellow-500/30 bg-yellow-500/5 text-sm" data-testid="banner-ai-disclaimer">
              <AlertTriangle className="h-4 w-4 text-yellow-500 mt-0.5 shrink-0" />
              <div>
                <span className="font-medium text-yellow-500">AI-Researched Data</span>
                <span className="text-muted-foreground"> — This allocation data was generated by AI from publicly available sources (whitepapers, blog posts, documentation). It may not be perfectly accurate. Review and edit as needed.</span>
              </div>
            </div>
          )}
